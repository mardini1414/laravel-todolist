       ...
       <div class="row justify-content-center">
           <div class="col-md-5">
            <header class="bg-white p-2 rounded my-2 shadow-sm">
                <h1 class="text-primary text-center mb-3">Laravel Todolist</h1>
                <form action="/add" method="POST" class="d-flex">
                    ...
                    <button class="btn btn-primary text-white fw-bold" type="submit">Add</button>
                </form>
            </header>
            @error('task')
            ...
            <main>
                <ul class="list-group list-group-flush rounded">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex">
                            <a href="/task/{{$list['id']}}/edit" class="btn btn-success btn-sm text-white">
                            ...
                            <form action="/delete/{{$list['id']}}" method="POST">
                                @csrf
                                @method('delete')
                                <button class="btn btn-danger btn-sm text-white ms-1" type="submit">
